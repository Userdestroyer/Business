...
class PDFFormatter
{
    ...
    string sourcePath = @"C:\Users\user\YandexDisk\ТУСУР\5 курс\2 семестр\СПРБП\Исходники\шаблон.txt";
    /// <summary>путь до выходного файла</summary>
    string distPath = @"C:\Users\user\YandexDisk\ТУСУР\5 курс\2 семестр\СПРБП\Результат\result.pdf";
